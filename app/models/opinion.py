...
class Opinion:
    ...
    def __init__(self, opinionId = None, author = None, rcmd = None, stars = None, content = None, pros = None,
                cons = None, purchased = None,publishDate = None, purchaseDate = None, useful = None, useless = None) -> None:
    ...
    def __str__(self) -> str:
        return f"opinionId: {self.opinionId}<br>" + "<br>".join(f"{key}: {str(getattr(self, key))}" for
        key in self.components.keys())

    def __repr__(self) -> str:
        return f"Opinion(opinionId={self.opinionId}, " + ", ".join(f"{key}={str(getattr(self, key))}" for
        key in self.components.keys()) + ")"